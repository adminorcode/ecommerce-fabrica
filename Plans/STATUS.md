...
| [026-checkout-dados-salvos-viacep.md](./026-checkout-dados-salvos-viacep.md) | Validado localmente — pronto para commit/PR | Checkout hidrata dados da conta e preenche endereço via ViaCEP ao informar o CEP. Validação local concluída; gate browser completo aprovado; pronto para commit/PR. ClickUp [86e2xzer3](https://app.clickup.com/t/86e2xzer3) |
