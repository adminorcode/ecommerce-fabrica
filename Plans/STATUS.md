...
| [026-checkout-dados-salvos-viacep.md](./026-checkout-dados-salvos-viacep.md) | Concluído | Entrega em `master` via [PR #7](https://github.com/adminorcode/ecommerce-fabrica/pull/7). Prefill autenticado (primeira carga) e ViaCEP no CEP do checkout. Gate PHP validado; residual E2E de prefill autenticado no Checkout Block documentado no plano. ClickUp [86e2xzer3](https://app.clickup.com/t/86e2xzer3) |
...
| [033-rodape-aproximacao-mockup.md](./033-rodape-aproximacao-mockup.md) | Concluído tecnicamente | Commit `1fcfa7a` enviado para `origin/033-rodape-aproximacao-mockup`; runtime, gates 023/033 PHP/browser e `git diff --check` validados. Revisão humana e merge pendentes. ClickUp [86e2yy6mc](https://app.clickup.com/t/86e2yy6mc) |
