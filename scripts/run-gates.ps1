...
Invoke-EvalFile 'validate-033-footer.php'
...
if ($Browser -or $Pdp -or $Cart) {
    ...
    try {
        ...
        if ($Browser) {
            ...
            foreach ($script in @('validate-005-session-01-browser.mjs', 'validate-005-session-02-browser.mjs', 'validate-005-catalog-layout-browser.mjs', 'validate-013-browser.mjs', 'validate-016-product-grid-browser.mjs', 'validate-018-commercial-pages-browser.mjs', 'validate-012-personalizer-browser.mjs', 'validate-023-footer-browser.mjs', 'validate-033-footer-browser.mjs', 'validate-024-home-campaigns-carousel-browser.mjs', 'validate-025-account-registration-browser.mjs', 'validate-030-order-received-browser.mjs', 'validate-032-search-browser.mjs', 'validate-039-cart-qty-browser.mjs', 'validate-035-menu-dropdown-browser.mjs', 'validate-no-theme-hero-browser.mjs')) {
