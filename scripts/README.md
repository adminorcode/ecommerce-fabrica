...
| `validate-033-footer.php` | 033 | Rodapé: composição legal em duas linhas com pagamento herdado do 023 |
| `validate-033-footer-browser.mjs` | 033 | Browser: três faixas do rodapé, selos com filetes/divisórias e matriz 1440/1024/390 |
