...
Read:
- `.agents/skills/wp-wpcli-and-ops/references/safety.md`
...
Read:
- `.agents/skills/wp-wpcli-and-ops/references/search-replace.md`
...
Read:
- `.agents/skills/wp-wpcli-and-ops/references/packages-and-updates.md`
...
Read:
- `.agents/skills/wp-wpcli-and-ops/references/cron-and-cache.md`
...
Read:
- `.agents/skills/wp-wpcli-and-ops/references/multisite.md`
...
Read:
- `.agents/skills/wp-wpcli-and-ops/references/automation.md`
...
See:
- `.agents/skills/wp-wpcli-and-ops/references/debugging.md`
...
Base directory for this skill: .agents/skills/wp-wpcli-and-ops
