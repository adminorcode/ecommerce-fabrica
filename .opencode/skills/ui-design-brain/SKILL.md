...
**Before writing any UI code**, consult this skill to select the right components and follow their best practices. Read [.agents/skills/ui-design-brain/components.md](../../.agents/skills/ui-design-brain/components.md) for the full reference.
...
Read the user's request and determine which UI components are needed. Reference [.agents/skills/ui-design-brain/components.md](../../.agents/skills/ui-design-brain/components.md) to find each component by name or alias.
...
Below are the 15 most commonly needed components. For the full 60+ component reference with best practices, aliases, and layout examples, see [.agents/skills/ui-design-brain/components.md](../../.agents/skills/ui-design-brain/components.md).
...
Base directory for this skill: .agents/skills/ui-design-brain
