...
Read:
- `.agents/skills/wp-block-development/references/creating-new-blocks.md`
...
Read:
- `.agents/skills/wp-block-development/references/block-json.md` (apiVersion and schema details)
...
- `.agents/skills/wp-block-development/references/block-json.md`
...
Read and apply:
- `.agents/skills/wp-block-development/references/registration.md`
...
Read:
- `.agents/skills/wp-block-development/references/supports-and-wrappers.md`
- `.agents/skills/wp-block-development/references/dynamic-rendering.md` (if dynamic)
...
Read:
- `.agents/skills/wp-block-development/references/inner-blocks.md`
...
Read:
- `.agents/skills/wp-block-development/references/attributes-and-serialization.md`
...
Read:
- `.agents/skills/wp-block-development/references/deprecations.md`
...
Read:
- `.agents/skills/wp-block-development/references/tooling-and-testing.md`
...
- `.agents/skills/wp-block-development/references/debugging.md` (common failures + fastest checks)
- `.agents/skills/wp-block-development/references/attributes-and-serialization.md` (attributes not saving)
- `.agents/skills/wp-block-development/references/deprecations.md` (invalid block after change)
...
Base directory for this skill: .agents/skills/wp-block-development
