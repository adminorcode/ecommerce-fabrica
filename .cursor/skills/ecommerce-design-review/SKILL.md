...
Consultar [references/design-tokens.md](references/design-tokens.md) (certo vs errado) e `wp-content/themes/petshop-theme/style.css`:
...
- Tokens e exemplos: [references/design-tokens.md](references/design-tokens.md)
